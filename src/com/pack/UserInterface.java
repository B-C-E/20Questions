...
// * @author Marty Stepp * @version 2010/02/20 */
public interface UserInterface
{
    ...
    final String SAVE_LOAD_FILENAME_MESSAGE = "File Name:";
    ...
    /**
     * Waits for the user to input a text value, and returns that answer as a String.     * @return the answer typed by the user as a String (empty string if no answer typed)
     */
    String nextLine();

    /**
     * Displays the given output message to the user.     * @param message The message to display.  Assumes not null.
     */
     ...
     */
    void println(String message);    // various messages that are output by the user interface
}
